...
class SearchInFilteredCatalog extends StatefulWidget {
  const SearchInFilteredCatalog({super.key});

  @override
  State<SearchInFilteredCatalog> createState() =>
      _SearchInFilteredCatalogState();
}

class _SearchInFilteredCatalogState extends State<SearchInFilteredCatalog> {
  @override
